...
# tbl9_eth1_val.u.forward.port = eth4_idx

tbl9_eth5_val = Tbl9Value()
tbl9_eth5_val.action = 0
tbl9_eth5_val.u.forward.port = eth5_idx

print("Populating DMAC table from the control plane")
# tbl9_tbl[tbl9_tbl.Key('\x10\x11\x12\x13\x14\x14')] = tbl9_eth1_val
tbl9_tbl[tbl9_tbl.Key('\x10\x11\x12\x13\x14\x15')] = tbl9_eth5_val
